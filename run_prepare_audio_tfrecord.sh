...
pai -name tensorflow1120
    ...
    -Dcluster='{\"worker\":{\"count\":200, \"gpu\":0, \"cpu\":400, \"memory\":10000}}'
    -DentryFile='./deepspeech/prepare_audio_tfrecord.py' 
    -DhyperParameters='file:///Users/xuhaotian/Desktop/my_work/deepspeech/prepare_audio_tfrecord_params'
