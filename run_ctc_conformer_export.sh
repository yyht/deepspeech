...
pai -name tensorflow1120
    ...
    -DentryFile='./deepspeech/run_ctc_conformer_export.py' 
    -DjobName='bert_qqp'
    -Dtags='bert'
    -DgpuRequired=0
    -DmaxHungTimeBeforeGCInSeconds=0
    -DmaxTrainingTimeInHour=1440
    -DhyperParameters='file:///Users/xuhaotian/Desktop/my_work/deepspeech/conformer_params_reduced_length_medium_pinyin_export'
